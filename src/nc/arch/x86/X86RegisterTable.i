 ...
 */
REG(rax,              RAX,              0,   0, 64, "Result register, also used in `idiv' and `imul' instructions")
REG(eax,              EAX,              0,   0, 32, "")
REG(ax,               AX,               0,   0, 16, "")
REG(al,               AL,               0,   0,  8, "")
REG(ah,               AH,               0,   8,  8, "")

REG(rbx,              RBX,              1,   0, 64, "Miscellaneous register")
REG(ebx,              EBX,              1,   0, 32, "")
REG(bx,               BX,               1,   0, 16, "")
REG(bl,               BL,               1,   0,  8, "")
REG(bh,               BH,               1,   8,  8, "")

REG(rcx,              RCX,              2,   0, 64, "Fourth Argument register")
REG(ecx,              ECX,              2,   0, 32, "")
REG(cx,               CX,               2,   0, 16, "")
REG(cl,               CL,               2,   0,  8, "")
REG(ch,               CH,               2,   8,  8, "")

REG(rdx,              RDX,              3,   0, 64, "Third argument register, also used in `idiv' and `imul' instructions")
REG(edx,              EDX,              3,   0, 32, "")
REG(dx,               DX,               3,   0, 16, "")
REG(dl,               DL,               3,   0,  8, "")
REG(dh,               DH,               3,   8,  8, "")

REG(rsp,              RSP,              4,   0, 64, "Stack pointer")
REG(esp,              ESP,              4,   0, 32, "")
REG(sp,               SP,               4,   0, 16, "")
REG(spl,              SPL,              4,   0,  8, "")

REG(rbp,              RBP,              5,   0, 64, "Frame pointer")
REG(ebp,              EBP,              5,   0, 32, "")
REG(bp,               BP,               5,   0, 16, "")
REG(bpl,              BPL,              5,   0,  8, "")

REG(rsi,              RSI,              6,   0, 64, "Second argument register")
REG(esi,              ESI,              6,   0, 32, "")
REG(si,               SI,               6,   0, 16, "")
REG(sil,              SIL,              6,   0,  8, "")

REG(rdi,              RDI,              7,   0, 64, "First argument register")
REG(edi,              EDI,              7,   0, 32, "")
REG(di,               DI,               7,   0, 16, "")
REG(dil,              DIL,              7,   0,  8, "")

REG(r8,               R8,               8,   0, 64, "Fifth argument register")
REG(r8d,              R8D,              8,   0, 32, "")
REG(r8w,              R8W,              8,   0, 16, "")
REG(r8b,              R8B,              8,   0,  8, "")

REG(r9,               R9,               9,   0, 64, "Sixth argument register")
REG(r9d,              R9D,              9,   0, 32, "")
REG(r9w,              R9W,              9,   0, 16, "")
REG(r9b,              R9B,              9,   0,  8, "")

REG(r10,              R10,              10,  0, 64, "Miscellaneous register")
REG(r10d,             R10D,             10,  0, 32, "")
REG(r10w,             R10W,             10,  0, 16, "")
REG(r10b,             R10B,             10,  0,  8, "")

REG(r11,              R11,              11,  0, 64, "Miscellaneous register")
REG(r11d,             R11D,             11,  0, 32, "")
REG(r11w,             R11W,             11,  0, 16, "")
REG(r11b,             R11B,             11,  0,  8, "")

REG(r12,              R12,              12,  0, 64, "Miscellaneous register")
REG(r12d,             R12D,             12,  0, 32, "")
REG(r12w,             R12W,             12,  0, 16, "")
REG(r12b,             R12B,             12,  0,  8, "")

REG(r13,              R13,              13,  0, 64, "Miscellaneous register")
REG(r13d,             R13D,             13,  0, 32, "")
REG(r13w,             R13W,             13,  0, 16, "")
REG(r13b,             R13B,             13,  0,  8, "")

REG(r14,              R14,              14,  0, 64, "Miscellaneous register")
REG(r14d,             R14D,             14,  0, 32, "")
REG(r14w,             R14W,             14,  0, 16, "")
REG(r14b,             R14B,             14,  0,  8, "")

REG(r15,              R15,              15,  0, 64, "Miscellaneous register")
